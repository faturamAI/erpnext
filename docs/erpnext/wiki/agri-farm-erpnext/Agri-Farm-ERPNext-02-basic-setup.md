...
Agri farm's core and most important elements are:
...
1. On the desk, clik on the **Land Unit** icon.
	[[assets/img/new-land-unit-icon.png]]
	A list will show any existing Land Units.

2. On the top right, click on **New** [[assets/img/new-button.png]] to create the first Land Unit.

	A dialog will open
	[[assets/img/new-land-unit-dialog.png]]

- In the Land Unit Name type: **Carrot farm**
- Leave **Parent Land Unit** empty.
- Check the box next to **Is Group**
- Click **Save** [[assets/img/save-button.png]]

3. With the farm created, we can now create our first Carrot Field!
	Click on **New** [[assets/img/new-button.png]]
...
## Crop
Now we need to specify what our crop will be. A crop summarizes all that is necessary before creating our first crop cycle or planting.

1. On the desk, click on the **Crop** icon.
	[[assets/img/crop-icon.png]]
	
	A list will show any existing Crops.

2. On the top right, click on **New** [[assets/img/new-button.png]] to create the first Crop.
	A new crop document will open, and we will enter basic information

	[[assets/img/new-crop-document.png]]
...
- Click **Save** [[assets/img/save-button.png]]
	...
	In the **Ideal Agriculture Task List** we enter some planned tasks such as planting, watering, and harvesting.
	(Please note, our activity list will be intentionally abbreviated for illustration purposes: For this example, we will prepare our field, plant the next day, water only once, add a cover after germination on day 12, remove weeds at day 19, and harvest at day 90
...
- Holiday Management: Previous Business Day
	...
	1. When done, you can click **Save** [[assets/img/save-button.png]] to prevent any work from being lost. We are not done yet, we simply have saved the minimum required information!
...
1. On the desk, clik on the **Crop Cycle** icon.
	[[assets/img/crop-cycle-icon.png]]
	A list will show any existing Crop Cycles.

2. On the top right, click on **New** [[assets/img/new-button.png]] to create the first Crop Cycle.
...
- **Save** [[assets/img/save-button.png]] the new Crop Cycle

4. Repeat step 2 for every Crop Cycle you need.

Back to [Agri Farm ERPNext Documentation](Agri-Farm-ERPNext-Documentation) - [Previous Page](Agri-Farm-ERPNext-01-introduction) - [Next Page](Agri-Farm-ERPNext-03-land-unit)
