...
1. You need to have a DNS [Mulitenant Setup](https://github.com/frappe/bench/wiki/Multitenant-Setup)
...
NB Although deemed to be 'experimental', this worked fine for me with the standard install method today ie Aug 17. Obviously using a non Ubuntu, or non standard server setup is potentially possible to affect the operation of auto-renewal
