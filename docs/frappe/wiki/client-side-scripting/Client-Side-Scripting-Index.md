...
[Fetch values from another document]((Client-Side-Scripting)Fetch-values-from-another-document.md)
[Fetch a child table]((Client-Side-Scripting)Fetching-child-tables.md)
