...
- [Event Streaming](https://github.com/frappe/event_streaming) (removed in [#17910](https://github.com/frappe/frappe/pull/17910))
...
The execution order of the `override_whitelisted_methods` hook changes. In v14, the first override was used. Starting from v15, the last override will be used. https://github.com/frappe/frappe/pull/22532